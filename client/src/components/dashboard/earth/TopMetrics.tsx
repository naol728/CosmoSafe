...
export default function TopMetrics({
    ...
    const floodData = flood?.daily?.time?.map((t: string, i: number) => ({
        date: t,
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {cards.map((card, idx) => {
                    ...
                    return (
                        ...
                        >
                            <Card className={`bg-gradient-to-br ${card.gradient} ${card.border} rounded-xl shadow-lg hover:shadow-2xl transition-shadow`}>
